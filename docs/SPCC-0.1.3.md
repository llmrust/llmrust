...
> **状态**：`ACTIVE SSOT — M2 进行中（public API freeze 生效）；下一任务 STR-003`  
> **目标版本**：`llmrust 0.1.3`  
...
| `0.1.3 / M2 Provider Correctness` | 修复流、reasoning、usage 契约 | 8/10 | 80% | `ACTIVE` | `STR-003` | 十项任务 DONE，能力声明与 fixture 一致 |
...
| `STR-003` | M2 | `READY` | `REA-002`,`REA-003`,`REA-004G`,`REA-004O` | — | — | — | — |
