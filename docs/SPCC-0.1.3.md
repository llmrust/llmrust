...
> **状态**：`ACTIVE SSOT — M2 进行中（public API freeze 生效）；下一任务 CAP-001`  
> **目标版本**：`llmrust 0.1.3`  
...
| `0.1.3 / M2 Provider Correctness` | 修复流、reasoning、usage 契约 | 9/10 | 90% | `ACTIVE` | `CAP-001` | 十项任务 DONE，能力声明与 fixture 一致 |
