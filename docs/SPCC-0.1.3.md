...
2. 本规格最新已批准版本；
3. `docs/CONTRACTS.md` 与项目内已批准的专用协议规格；
4. 公开 API 测试、契约测试与 wire fixtures；
5. 代码实现；
6. README、示例、能力表和注释。
...
| `0.1.3 / M0 Foundation` | 建立不可绕过的治理与发布门禁 | 2/5 | 40% | `ACTIVE` | `CI-002` | 五项任务 DONE，负向门禁证据齐全 |
...
| `CI-001` | M0 | `DONE` | `SPEC-000` | [#83](https://github.com/llmrust/llmrust/issues/83) | [#85](https://github.com/llmrust/llmrust/pull/85) | `c01239d548d50df4b299e166d67f5faf86d2f24c` | 待创建 |
| `CI-002` | M0 | `READY` | `CI-001`,`INC-001` | — | — | — | — |
| `CI-003` | M0 | `BLOCKED` | `CI-001` | — | — | — | — |
| `REL-001` | M0 | `BLOCKED` | `CI-002`,`CI-003`,`INC-002` | — | — | — | — |
| `API-001` | M1 | `BLOCKED` | M0 DONE | — | — | — | — |
...
| `CI-001` | [#83](https://github.com/llmrust/llmrust/issues/83) | [PR #85](https://github.com/llmrust/llmrust/pull/85) | CI run `29268965499`（MSRV、Test 全绿；run `29268920362` 提供真实取消证据） | `c01239d548d50df4b299e166d67f5faf86d2f24c`（2026-07-14 01:38 CST） | 待创建 | M0 2/5（40%） | `DONE` — Codex |
